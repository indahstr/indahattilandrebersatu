#ifndef LINKEDLIST_SOAL_H
#define LINKEDLIST_SOAL_H
...
void createNodeLL(pointerLL& New,qint16 tema,qint16 noSoal,QString soal,QString opsiA,QString opsiB,QString opsiC,QString opsiD,char jwb){
New = new LLNode;
New->tema = tema;
New->noSoal = noSoal;
New->soal = soal;
